...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chat.buildSentence': 'build a sentence and tap',
    'chat.toStart': 'to start',
    'chat.unknown': 'Unknown',
    'chat.send': 'Send',
    'chat.sendLabel': 'Send',
    'chat.typeReply': 'Type a reply…',
    'chat.sendFirstSentence': 'Send your first sentence!',
    'chat.noPairedUsers': 'No paired users yet.',
    'chat.goTo': 'Go to',
    'chat.patients': 'Patients',
    'chat.toSendInvite': 'to send an invite.',
    'chat.selectPerson': 'Select a person above to start chatting',
    ...
    'settings.voice.selectDesc': 'Stored on this device',
    'settings.voice.browserDefault': 'Browser default voice',
    'settings.voice.noVoiceMatch': 'No close language match found. You can still choose another installed voice.',
  ...
  no: {
    ...
    'chat.lastActive': 'Sist aktiv',
    'chat.ago': 'siden',
    'chat.noMessages': 'Ingen meldinger ennå',
    'chat.noMessagesYet': 'Ingen meldinger ennå.',
    'chat.buildSentence': 'lag en setning og trykk',
    'chat.toStart': 'for å starte',
    'chat.unknown': 'Ukjent',
    'chat.send': 'Send',
    'chat.sendLabel': 'Send',
    'chat.typeReply': 'Skriv et svar…',
    'chat.sendFirstSentence': 'Send din første setning!',
    'chat.noPairedUsers': 'Ingen sammenkoblede brukere ennå.',
    'chat.goTo': 'Gå til',
    'chat.patients': 'Pasienter',
    'chat.toSendInvite': 'for å sende en invitasjon.',
    'chat.selectPerson': 'Velg en person over for å starte chatten',
    ...
    'settings.voice.select': 'Stemme',
    'settings.voice.selectDesc': 'Lagres på denne enheten',
    'settings.voice.browserDefault': 'Nettleserens standardstemme',
    'settings.voice.noVoiceMatch': 'Fant ingen nær språkmatch. Du kan likevel velge en annen installert stemme.',
